		...
		\begin{column}{0.5\textwidth}
			\begin{center}
				\resizebox{0.8\textwidth}{!}{
					\begin{tikzpicture}
						\tikzset{
							terminal/.style={draw, shape=circle, fill=TUMExtRed, inner sep=3pt},
							hanan/.style={draw, shape=circle, fill=TUMExtRed!30, inner sep=3pt},
							hananline/.style={color=TUMExtRed, dashed, very thick},
							marker/.style={draw, shape=circle, dashed, color=TUMExtRed, thick, inner sep=5pt},
