		...
		\begin{column}{0.5\textwidth}
			...
			\only<3->{
				...
				\begin{enumerate}
					...
					\item<5-> Wähle die Verbindung, deren Hanan-Punkte den geringsten Abstand zu einem der anderen Terminalknoten hat
					\item<6-> Füge diese Verbindung dem Steinerbaum hinzu und fahre mit Schritt 2 fort
				\end{enumerate}
